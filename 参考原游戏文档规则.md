...
Players Per Team
There is no limit on how many players you can hold from a single NBA team.
...
Transactions
After selecting your roster, you can sign and waive players in the transactions tab. Unlimited transactions can be made at no cost until the Day 1 deadline.

After the Day 1 deadline, each team has 6 free transactions for the entire playoffs.

Once those 6 free transactions are used, every additional normal transfer deducts 50 points from your total score at the next deadline.
...
Each manager has one All-Star chip for the playoffs.

Each manager has one Wildcard chip for the playoffs.
...
No, only one chip may be active in a Gameday. For example, it is not possible to make transactions with your Wildcard chip and then use your All-Star chip in the same Gameday.
