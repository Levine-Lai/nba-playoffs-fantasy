...
export const HELP_RULES = {
  rosterRules: [
    ...
    "After the Day 1 deadline, each team gets 8 free transfers for the entire playoffs.",
    "Once those 8 playoff free transfers are gone, each extra normal transfer costs -50 points.",
