...
- Game rules live in SQLite game_rules: initial_budget, weekly_free_transfers, transfer_penalty, first_deadline.
- Transactions are limitless before first_deadline and cost a flat points penalty per move after launch.`
  },
  {
    id: "doc-5",
